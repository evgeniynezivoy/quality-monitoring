...
### По специалистам (Outsource рейты)
...
*Ставки указаны для аутсорс-компаний (клиентский рейт)

### По специалистам (Internal - зарплаты в Украине)

| Специалист | Часы | Зарплата (USD/мес)** | Месяцев работы | Стоимость (USD) |
|------------|------|----------------------|----------------|-----------------|
| Backend Developer (Senior) | 160-200 | $2,500 - $3,500 | 1.0 - 1.2 | $2,500 - $4,200 |
| Frontend Developer (Senior) | 160-200 | $2,500 - $3,500 | 1.0 - 1.2 | $2,500 - $4,200 |
| DevOps Engineer (Middle) | 24-40 | $2,000 - $2,800 | 0.15 - 0.25 | $300 - $700 |
| QA Engineer (Middle) | 40-60 | $1,500 - $2,200 | 0.25 - 0.35 | $375 - $770 |
| Project Manager | 40-60 | $2,000 - $3,000 | 0.25 - 0.35 | $500 - $1,050 |
| **ИТОГО Internal** | **424-560** | | **2.5-3 мес** | **$6,175 - $10,920** |

**Зарплаты по данным DOU.ua / Djinni 2025-2026 для Украины
...
### По срокам (Internal команда)

| Вариант | Команда | Срок | Зарплатный фонд/мес | Стоимость |
|---------|---------|------|---------------------|-----------|
| **Минимальный** | 2 Full-stack ($3K каждый) | 10-12 недель | $6,000 | $15,000-18,000 |
| **Оптимальный** | BE + FE + DevOps (частично) | 8-10 недель | $7,500 | $15,000-18,750 |
| **Реалистичный** | BE + FE + QA + PM (частично) | 8-10 недель | $9,000 | **$6,200-11,000** |

> **Важно:** Internal оценка ($6,200-11,000) учитывает только прямые зарплаты.
> Не включены: налоги (~20%), офис, оборудование, больничные, отпуска, онбординг.
...
## 7. Сравнение подходов к разработке

| Подход | Команда | Срок | Стоимость | Примечания |
|--------|---------|------|-----------|------------|
| **Outsource** | 3-4 человека | 8-12 недель | $16,000 - $32,000 | Клиентские рейты |
| **Internal команда** | 3-4 человека | 8-12 недель | $6,200 - $11,000 | Только зарплаты |
| **Internal + overhead** | 3-4 человека | 8-12 недель | $8,000 - $14,000 | +налоги, офис |
| **AI-Assisted** | 1 человек + AI | 2-3 недели | $500 - $1,500 | API + время специалиста |

### Детали AI-Assisted разработки (Claude Code)
- **Срок:** 2-3 недели (фактически этот проект)
- **API costs:** ~$200-500
- **Время специалиста:** ~40-60 часов (постановка задач, ревью, тестирование)
- **Эффективность:** x4-x6 быстрее традиционной разработки
...
- Постановки задач и требований
- Code review и принятия архитектурных решений
- Тестирования и отладки
- Deployment и настройки инфраструктуры

### ROI сравнение

| Метрика | Outsource | Internal | AI-Assisted |
|---------|-----------|----------|-------------|
| Стоимость | $24,000 (avg) | $9,000 (avg) | $1,000 (avg) |
| Срок | 10 недель | 10 недель | 2.5 недели |
